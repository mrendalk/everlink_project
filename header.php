        ...
        <header class="tech-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="uploads/<?= $siteData['logo']?>" alt="" style="width: 15%; height: auto;"><strong> Ever Link</strong></a>
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="register.php">Register Company</a>
                            </li>
                            <li class="nav-item">
